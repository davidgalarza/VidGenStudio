...
Elige **Proyecto de historia** al crear el proyecto. Abre directamente en **Guion y escenas**, en la etapa guardada: guion, propuesta o producción. Pega solo lo que se escuchará y elige **Cómo se escucha** y **Estilo visual**; los valores iniciales son voz en off y Realista. Gemini propone escenas, reparto, lugares y referencias de Nano Banana respetando ese modo y estilo. Revisa y edita el plan; después pulsa **Producir historia** para crear la voz con Gemini TTS cuando corresponda y generar los vídeos en segundo plano. Todo usa la misma clave de Google. Las escenas se añaden al montaje; con voz en off puedes regenerar una imagen sin rehacer la narración y descargar los materiales para tu editor local. Consulta la [guía de Historia](story.md) para voces, duración y límites.

**Estilo visual** ofrece 36 opciones para voz en off y 32 para personajes hablando, con búsqueda por técnica o uso, filtros y favoritos locales. Abrir una muestra muestra sus detalles; puedes comparar hasta tres estilos, incluidos los personales, antes de pulsar **Usar**. **Personalizar** o **Ajustar estilo** permite controlar ritmo, cámara, luz, color, detalle y explicación o actuación. **Crear estilo** parte de una configuración editable; **Mis estilos** permite guardar, editar, clonar y eliminar tus opciones sin modificar proyectos que ya las usan. Las muestras no cambian al ajustar controles y no garantizan el resultado del vídeo.

Cerrar el editor de estilo deja un ajuste temporal que puedes retomar con **Continuar ajuste**, incluso después de cambiar entre Escenas y Voz y estilo. **Cancelar** lo descarta y **Usar** lo aplica. Recargar o salir de la vista pierde ese pendiente; **Guardar en Mis estilos** conserva una copia con sus archivos.

También puedes subir o arrastrar hasta seis imágenes o vídeos (14 MiB combinados) y pulsar **Analizar con Gemini**. El análisis consume cuota, devuelve una propuesta revisable y solo cambia los ajustes cuando pulsas **Aplicar análisis**. Los archivos no se añaden automáticamente a la generación: se utiliza la dirección visual extraída. **Usar estos ajustes** aplica la configuración al proyecto; **Guardar en Mis estilos** conserva una copia con sus archivos en este navegador. Consulta [estilos y referencias para análisis](story.md#elegir-y-personalizar-un-estilo) para formatos, privacidad y límites.
