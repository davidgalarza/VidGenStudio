...
- **Dirección visual:** 58 estilos distintos, con 36 opciones para voz en off y 32 para personajes hablando. Explora detalles y recomendaciones de uso, compara hasta tres estilos, marca favoritos y personaliza seis controles por modo. El análisis opcional de imágenes o vídeos con Gemini propone ajustes revisables, sin adjuntar esos archivos automáticamente a la generación. Solo **Usar** aplica la elección.
